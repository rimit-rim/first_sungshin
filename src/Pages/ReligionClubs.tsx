...
const allClubs: { [key: string]: Club[] } = {
  ...
  'Religion': [
    { name: 'Mary', 
      description: 'Sungshin Catholic Students Association ', 
      subDescription: "Weekly meeting, Catholic Events", 
      instagram: 'https://www.instagram.com/ssmaria_catholic' },
      { name: 'Seong Bool Hwae', 
      description: 'Sungshin Buddhist Students Association', 
      subDescription: "Regular Buddhist ceremony,Temple Stay, Lotus Lantern Festival participation", 
      instagram: 'https://www.instagram.com/sungbul_sswu/' },
      { name: 'Sungshin IVF', 
      description: 'Inter-Varsity Christian Fellowship', 
      subDescription: "Sungshin Bracnch of Korea Christian Students Association", 
      instagram: ' https://www.instagram.com/sungshinivf/' },
      { name: 'C.C.C. ', 
      description: 'Campus Crusade for Christ ', 
      subDescription: "Korea Students Missionary Union", 
      instagram: ' https://www.instagram.com/sswu_ccc/' }
    ],
  'Hobby': [],
  'Sports': [],
  'Academic Study': [],
...
export default function ReligionClubs() {
  ...
  const clubsToShow = allClubs['Religion']; // <-- 키가 일치하므로 정상 작동
      ...
      <main className="px-4 sm:px-6 md:px-10 xl:px-[100px] my-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <section className="w-full md:w-3/4 bg-violet-100 p-4 sm:p-6 rounded-2xl">
            <h2 className="text-xl font-bold text-gray-800 mb-6">Clubs in Religion Department</h2>
