...
const allClubs: { [key: string]: Club[] } = {
  Performance: [
    ...
    { name: 'Drama Club', description: 'Sungshin Drama Club', instagram: 'https://www.instagram.com/sungshin.drama.club/' },
    { name: 'Wheemori', description: 'Korean Traditional Mask Dance Club', instagram: 'https://www.instagram.com/wheemori_1978/' },
    { name: 'Hipton', description: 'Street Dance Club', instagram: 'https://www.instagram.com/sswu_hiption/' },
    { name: 'Thirsty Soul', description: 'Sungshin Rock Band', instagram: 'https://www.instagram.com/sswuthirstysoul/' },
    { name: 'Hyaline', description: 'Musical Club', instagram: 'https://www.instagram.com/hyaline_sswu/' },
    { name: 'Flare', description: 'Sungshin Cheerleading Club', instagram: 'https://www.instagram.com/sungshin_cheer/' },
    { name: 'Wednesday Club', description: 'Pop Music Band', instagram: 'https://www.instagram.com/sswu_wednesdayclub/' },
  ],
  'Community Service': [],
  Art: [],
  Religion: [],
...
const ClubCard: React.FC<{ club: Club }> = ({ club }) => (
    <div className="flex flex-col sm:flex-row items-center w-full">
      <div className="bg-white w-40 h-28 rounded-xl flex items-center justify-center mb-4 sm:mb-0 sm:mr-6 flex-shrink-0">
        <span className="font-semibold text-gray-700 text-2xl text-center">{club.name.split(' ')[0]} <br /> {club.name.split(' ').slice(1).join(' ')}</span>
      </div>
...
export default function PerformanceClubs() {
  const [isSidebarOpen, setSidebarOpen] = useState(false);
  
  const clubsToShow = allClubs.Performance;
      ...
      <main className="px-4 sm:px-6 md:px-10 xl:px-[100px] my-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <section className="w-full md:w-3/4 bg-violet-100 p-4 sm:p-6 rounded-2xl">
            <h2 className="text-xl font-bold text-gray-800 mb-6">Clubs in Performance Department</h2>
