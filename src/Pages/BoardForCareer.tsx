  ...
  return (
    <div className="flex flex-col items-center w-full font-pretendard">
      ...
      <div className="w-[1240px] flex items-center justify-between mb-6">
        <div className="text-[28pt] font-medium font-pretendard">Career</div>
        <button
          onClick={() => navigate("/create", { state: { board: "career" } })}
      ...
      <div className="w-[1240px] flex flex-col gap-4">
        {sortedPosts.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 text-sm mt-2">Be the first to write a post about careers!</p>
          </div>
        ) : (
          sortedPosts.map((post) => (
            ...
            >
              ...
              {/* 본문 첫 줄만 표시 */}
              <div className="w-[1096px] h-[40px] text-[17pt] font-light font-pretendard text-black truncate">
                {post.content.split("\n")[0]}
              </div>
