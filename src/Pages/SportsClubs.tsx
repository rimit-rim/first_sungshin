...
const allClubs: { [key: string]: Club[] } = {
  ...
  'Sports': [
  { 
    name: 'Sungshin Ski Team', 
    description: 'Ski club', 
    subDescription: "Winter training, Ski Competition participation, Ski Camp Volunteering", 
    instagram: 'https://www.instagram.com/sswuski_s2/' },
  { 
    name: 'FC Crystals', 
    description: 'Football Club', 
    subDescription: "Regular training, Football Competition participation, Friendly Matches with other schools", 
    instagram: 'https://www.instagram.com/fc_crystals/' },
  { 
    name: 'SPEC', 
    description: 'Basketball Club', 
    subDescription: "Sungshin P.E Club, University basketball competition participation", 
    instagram: 'https://www.instagram.com/spec_sswu/' },
  { 
    name: 'AND', 
    description: 'Volleyball Club', 
    subDescription: "Regular volleyball training", 
    instagram: 'https://www.instagram.com/sswu_and/' }
  ],
  'Academic Study': [],
};
...
export default function SportsClubs() {
  ...
  const clubsToShow = allClubs['Sports']; // <-- 키가 일치하므로 정상 작동
      ...
      <main className="px-4 sm:px-6 md:px-10 xl:px-[100px] my-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <section className="w-full md:w-3/4 bg-violet-100 p-4 sm:p-6 rounded-2xl">
            <h2 className="text-xl font-bold text-gray-800 mb-6">Clubs in Sports Department</h2>
