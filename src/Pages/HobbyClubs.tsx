...
const allClubs: { [key: string]: Club[] } = {
  ...
  'Hobby': [{ 
    name: 'Grimirang', 
    description: 'Grim-i-rang', 
    subDescription: "Subculture content creation, Exhibition holding, Art exhibition trip", 
    instagram: 'https://www.instagram.com/sswu.grimirang/' },
    { 
      name: 'Sungshin Hiking Club', 
      description: 'Climbing/Mountain Hiking Club', 
      subDescription: "Climbing, Mountain Hiking", 
      instagram: 'https://www.instagram.com/sswu_isac/' },
    { 
      name: 'Jinseong', 
      description: 'Tea Club', 
      subDescription: "Learning tea culture, Tea festival participation", 
      instagram: 'https://www.instagram.com/sswujinseong/' },
    { 
      name: 'Seolhwa', 
      description: 'Snowboarding Club', 
      subDescription: "Snowboarding Competition participaation, Off-season skateboarding", 
      instagram: 'https://www.instagram.com/sulhwa_sswu/' },
    { 
      name: 'Habo', 
      description: 'Astronomical Observation', 
      subDescription: "Observing celestial bodies", 
      instagram: 'https://www.instagram.com/habo.sungshin/' },
    { 
      name: 'SWIN', 
      description: 'International Students Networking Club', 
      subDescription: "Culture/Language exchange, Activities with Korean and international students", 
      instagram: 'https://www.instagram.com/sungshin_swin/' 
    },
  ],
  'Sports': [],
  'Academic Study': [],
...
// --- 메인 페이지 컴포넌트 ---
export default function HobbyClubs() {
  const [isSidebarOpen, setSidebarOpen] = useState(false);

  const clubsToShow = allClubs['Hobby']; 
      ...
      <main className="px-4 sm:px-6 md:px-10 xl:px-[100px] my-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <section className="w-full md:w-3/4 bg-violet-100 p-4 sm:p-6 rounded-2xl">
            <h2 className="text-xl font-bold text-gray-800 mb-6">Clubs in Hobby Department</h2>
